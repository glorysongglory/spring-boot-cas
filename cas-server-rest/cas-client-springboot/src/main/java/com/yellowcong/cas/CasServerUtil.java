...
public class CasServerUtil {
	...
	//目标返回的服务器的url
	//反斜杠一定要注意了
	private static final String TAGET_URL = "http://172.16.52.184:9001/";
...
//		hsu.setSSLSocketFactory(sc.getSocketFactory());
//		HttpsURLConnection.setDefaultSSLSocketFactory(sc.getSocketFactory());
        hsu.setDoInput(true);
        hsu.setDoOutput(true);
		hsu.setHostnameVerifier(new CustomizedHostnameVerifier());
